...
<header class="bg-green-700 text-white fixed top-0 w-full shadow-md z-50">
  <div class="flex items-center justify-between max-w-6xl mx-auto px-6 py-4">
    ...
    <div class="flex items-center space-x-4">
      ...
      <span class="text-2xl font-bold">Edit Artikel | <i>Arif Amrullah 275</i></span>
    </div>
...
<main class="w-3/4 bg-white rounded shadow p-6 ml-6">
    ...
    <div>
        ...
        <input type="text" id="nama_artikel" name="nama_artikel" required value="<?php echo htmlspecialchars($data['nama_artikel']); ?>"
    ...
    <div>
        ...
        <textarea id="isi_artikel" name="isi_artikel" rows="5" required class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-blue-500"><?php echo htmlspecialchars($data['isi_artikel']); ?></textarea>
    </div>

    <!-- Update & Cancel -->
    <div class="flex justify-end space-x-4">
        <button type="submit"
            class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-800 transition">Update</button>
