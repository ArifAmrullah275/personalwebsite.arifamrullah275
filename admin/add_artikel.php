...
<header class="bg-green-700 text-white fixed top-0 w-full shadow-md z-50">
  <div class="flex items-center justify-between max-w-6xl mx-auto px-6 py-4">
    ...
    <div class="flex items-center space-x-4">
      ...
      <span class="text-2xl font-bold">Tambah Artikel Baru | <i>Arif Amrullah 275</i></span>
    </div>
...
<form action="proses_add_artikel.php" method="post" class="space-y-6">
    ...
    <div>
        ...
        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-green-500"></textarea>
    </div>

    <!-- Simpan & Batal -->
    <div class="flex justify-end space-x-4">
        <button type="submit" class="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-800 transition">Simpan</button>
