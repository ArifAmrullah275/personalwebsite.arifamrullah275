...
<header class="bg-green-700 text-white fixed top-0 w-full shadow-md z-50">
  <div class="flex items-center justify-between max-w-6xl mx-auto px-6 py-4">
    ...
    <div class="flex items-center space-x-4">
      ...
      <span class="text-2xl font-bold">Tambah Gambar ke Gallery | <i>Arif Amrullah 275</i></span>
    </div>
...
<main class="w-3/4 bg-white rounded shadow p-6 ml-6">
    ...
    <div>
        ...
        class="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-100 file:text-green-700 hover:file:bg-green-200">
    </div>
